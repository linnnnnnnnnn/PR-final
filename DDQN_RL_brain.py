...
class DDQNWithPresetReplay(DoubleDQN):
    def __init__(
            self,
            n_actions,
            n_features,
        ...
        super(DDQNWithPresetReplay, self).__init__(n_actions, n_features, learning_rate, reward_decay,
                                                   e_greedy, replace_target_iter, memory_size, batch_size, e_greedy_increment, output_graph, double_q, sess)
    ...
    def learn(self):
        ...
        # sample batch memory from both memory blocks
